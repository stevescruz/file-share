...
export const uploadMultipleFilesMiddleware = multer(multerOptions).array(fieldName, maxFileCount);
export const uploadSingleFileMiddleware = multer(multerOptions).single(fieldName);
